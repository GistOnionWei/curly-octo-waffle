...
Libercoinのチェーンの全ての情報はこれらによって成り立っている:
...
Libercoinの全ての状態を知っていれば、これらをバリデートできる:
...
Libercoinにおけるアウトプット、レンジプルーフ、カーネルのデータストレージはシンプルで、メモリーマップドなデータアクセスができる追記型のプレーンなファイルを使用。
