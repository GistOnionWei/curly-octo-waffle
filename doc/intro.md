...
A detailed post on the step-by-step of how Libercoin transactions work (with graphics) can be found [in this Medium post](https://medium.com/@brandonarvanaghi/libercoin-transactions-explained-step-by-step-fdceb905a853). 
